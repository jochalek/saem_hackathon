...
| mean_cluster_confidence | 0.22960785031318665 |
...
- encounter_id=E001622
  symptoms=['awareness of rapid heartbeat', 'generalized tiredness', 'major traumatic mechanism', 'marked restlessness', 'nausea/vomiting', 'persistent unilateral neurologic deficit', 'ringing in ears', 'sense of internal unease']
  time_prior_to_arrival_minutes=107
  context=arrival_mode=festival_tent_transfer, origin=medical_tent
- encounter_id=E001562
  symptoms=['agitation', 'dry mouth', 'fatigue progression', 'hypoxia', 'major traumatic mechanism', 'mild tremor', 'queasy feeling']
  time_prior_to_arrival_minutes=205
  context=arrival_mode=walk_in, origin=main_stage